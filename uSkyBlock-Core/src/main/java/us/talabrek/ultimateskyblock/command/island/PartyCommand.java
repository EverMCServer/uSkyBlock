...
public class PartyCommand extends CompositeCommand {
    ...
    public PartyCommand(final uSkyBlock plugin, SkyBlockMenu menu, final InviteHandler inviteHandler) {
        super("party", null, tr("show party information"));
        this.plugin = plugin;
        this.menu = menu;
        add(new AbstractCommand("info", "usb.party.info", tr("shows information about your party")) {
            @Override
        ...
        add(new AbstractCommand("invites", "usb.party.invites", tr("show pending invites")) {
            @Override
            public boolean execute(CommandSender sender, String alias, Map<String, Object> data, String... args) {
        ...
        add(new AbstractCommand("uninvite", "usb.party.uninvite", "player", tr("withdraw an invite")) {
            @Override
